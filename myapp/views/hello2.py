...
def test():
	...
	res = es.search(index="lib-index", size=1000, body={"query": {"nested":{"path":"datagroup", "query":{"match": {"datagroup.taggroup": test}}}}})  # 1st Search
	
					
	return render_template("layout.html", test=test, test1=test1, res=res)
